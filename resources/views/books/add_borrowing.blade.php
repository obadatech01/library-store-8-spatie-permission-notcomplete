    ...
    <div class="row small-spacing">
      <div class="col-lg-12 col-xs-12">
        <div class="box-content card white">
          <h4 class="box-title">استعارة كتاب <span class="label bg-danger">{{$books->name}}</span></h4>
          <!-- /.box-title -->
          <div class="card-content">
            <form action="{{route('books.storeBorrowing',$id)}}" method="post" class="form-horizontal">
              @csrf
