    ...
    <div class="row small-spacing">
      <div class="col-lg-12 col-xs-12">
        <div class="box-content card white">
          <h4 class="box-title">إضافة مستعير جديد</h4>
          <!-- /.box-title -->
          <div class="card-content">
            <form action="{{route('borrowings.store')}}" method="post" class="form-horizontal">
              @csrf
              <div class="form-group">
                <label for="name" class="col-sm-3 control-label">اسم المستعير<span class="text-danger">*</span></label>
                <div class="col-sm-9">
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="اسم المستعير" autofocus />
                  @error('name')
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="العنوان" autofocus />
                  @error('address')
                  <span class="invalid-feedback text-danger" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" id="mobile" placeholder="رقم الجوال" />
                  @error('mobile')
                  <span class="invalid-feedback text-danger" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input list="books" class="@error('book_id') is-invalid @enderror" id="book_id" name="book_id" placeholder="اختر الكتاب...">
                    <datalist id="books">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="date" name="date_start" class="form-control @error('date_start') is-invalid @enderror" id="date_start" placeholder="Y-m-d" />
                  @error('date_start')
                  <span class="invalid-feedback text-danger" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="borrowing_period" class="form-control @error('borrowing_period') is-invalid @enderror" id="borrowing_period" placeholder="15 يوم" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" name="note" id="note" placeholder="ملاحظات"></textarea>
                </div>
              </div>
